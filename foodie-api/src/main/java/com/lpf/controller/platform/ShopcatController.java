...
import com.lpf.utils.RedisOperator;
...
public class ShopcatController {
    ...
    @PostMapping("/add")
    public ResultJSONResult add(@RequestParam String userId, @RequestBody ShopcartBO shopcartBO,
    ...
    @PostMapping("/del")
    public ResultJSONResult del(@RequestParam String userId, @RequestParam String itemSpecId,
                                HttpServletRequest request, HttpServletResponse response) {

        if (StringUtils.isBlank(userId) || StringUtils.isBlank(itemSpecId)) {
            return ResultJSONResult.errorMsg("参数不能为空");
        }
