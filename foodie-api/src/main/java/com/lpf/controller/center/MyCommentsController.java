package com.lpf.controller.center;
...
public class MyCommentsController {
    ...
    @PostMapping("/pending")
    public ResultJSONResult pending(
        ...
        if (myOrder.getIsComment() == YesOrNo.YES.type) {
            return ResultJSONResult.errorMsg("该笔订单已经评价");
        }
    ...
    public ResultJSONResult saveList(
        ...
        if (commentList == null || commentList.isEmpty() || commentList.size() == 0) {
            return ResultJSONResult.errorMsg("评论内容不能为空！");
        }
    ...
    public ResultJSONResult query(
        ...
        if (pageSize == null) {
            pageSize = PageConsts.COMMON_PAGE_SIZE;
        }
     ...
     * @return
     */
    private ResultJSONResult checkUserOrder(String userId, String orderId) {
